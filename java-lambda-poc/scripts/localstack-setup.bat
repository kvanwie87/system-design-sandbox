...
REM Build state machine definition with actual ARNs (uses lambda:invoke integration)
set SM_DEF={\"Comment\":\"CSV Processing Pipeline\",\"StartAt\":\"DownloadAndParse\",\"States\":{\"DownloadAndParse\":{\"Type\":\"Task\",\"Resource\":\"arn:aws:states:::lambda:invoke\",\"Parameters\":{\"FunctionName\":\"%DOWNLOAD_ARN%\",\"Payload.$\":\"$\"},\"OutputPath\":\"$.Payload\",\"Next\":\"CheckDownloadStatus\"},\"CheckDownloadStatus\":{\"Type\":\"Choice\",\"Choices\":[{\"Variable\":\"$.status\",\"StringEquals\":\"ERROR\",\"Next\":\"ProcessingFailed\"},{\"Variable\":\"$.status\",\"StringEquals\":\"EMPTY\",\"Next\":\"EmptyFile\"}],\"Default\":\"FilterRows\"},\"FilterRows\":{\"Type\":\"Task\",\"Resource\":\"arn:aws:states:::lambda:invoke\",\"Parameters\":{\"FunctionName\":\"%FILTER_ARN%\",\"Payload.$\":\"$\"},\"OutputPath\":\"$.Payload\",\"Next\":\"EnrichRows\"},\"EnrichRows\":{\"Type\":\"Task\",\"Resource\":\"arn:aws:states:::lambda:invoke\",\"Parameters\":{\"FunctionName\":\"%ENRICH_ARN%\",\"Payload.$\":\"$\"},\"OutputPath\":\"$.Payload\",\"Next\":\"WriteOutput\"},\"WriteOutput\":{\"Type\":\"Task\",\"Resource\":\"arn:aws:states:::lambda:invoke\",\"Parameters\":{\"FunctionName\":\"%OUTPUT_ARN%\",\"Payload.$\":\"$\"},\"OutputPath\":\"$.Payload\",\"Next\":\"CheckOutputStatus\"},\"CheckOutputStatus\":{\"Type\":\"Choice\",\"Choices\":[{\"Variable\":\"$.status\",\"StringEquals\":\"ERROR\",\"Next\":\"ProcessingFailed\"}],\"Default\":\"ProcessingComplete\"},\"ProcessingComplete\":{\"Type\":\"Succeed\"},\"EmptyFile\":{\"Type\":\"Succeed\"},\"ProcessingFailed\":{\"Type\":\"Fail\",\"Cause\":\"Processing error\",\"Error\":\"ProcessingError\"}}}
